...
const hotels = [
  {
    ...
    description: 'Perched on the pristine shores of Maldives, The Grand Azure Resort offers an unparalleled luxury experience. Wake up to turquoise lagoons, dine at underwater restaurants, and surrender to world-class spa treatments.',
    ...
    location: {
      ...
      nearbyAttractions: [
        { name: 'Coral Reef', distance: '0.1 km', type: 'beach' },
        { name: 'Dolphin Cove', distance: '2 km', type: 'nature' },
      ],
    },
  ...
  },
  {
    ...
    description: 'Carved into the volcanic cliffs of Oia, Santorini Cliffside Suites blends Cycladic architecture with modern luxury. Each suite features private infinity pools overlooking the iconic caldera and Aegean Sea.',
    ...
    location: {
      ...
      nearbyAttractions: [
        { name: 'Oia Castle', distance: '0.3 km', type: 'landmark' },
        { name: 'Red Beach', distance: '8 km', type: 'beach' },
      ],
    },
    coverImage: { url: HOTEL_IMAGES[1] },
    images: [{ url: HOTEL_IMAGES[1], isPrimary: true }, { url: HOTEL_IMAGES[3] }, { url: HOTEL_IMAGES[5] }],
    amenities: {
  ...
  },
  {
    ...
    description: 'Located in the heart of Shinjuku, Tokyo Skyline Tower Hotel offers breathtaking panoramic views of Mount Fuji and the Tokyo cityscape. Combining Japanese minimalism with cutting-edge technology.',
    ...
    location: {
      ...
      nearbyAttractions: [
        { name: 'Shinjuku Gyoen', distance: '1.2 km', type: 'park' },
        { name: 'Tokyo Metropolitan Government', distance: '0.5 km', type: 'landmark' },
      ],
    },
    coverImage: { url: HOTEL_IMAGES[2] },
    images: [{ url: HOTEL_IMAGES[2], isPrimary: true }, { url: HOTEL_IMAGES[4] }, { url: HOTEL_IMAGES[6] }],
    amenities: {
    ...
    rooms: [
      ...
      { roomType: 'Deluxe', pricePerNight: 320, maxGuests: 2, bedType: 'King', size: 48, totalRooms: 30, amenities: ['Mt Fuji View', 'Bathtub', 'Lounge Access'] },
      { roomType: 'Suite', pricePerNight: 580, maxGuests: 3, bedType: 'King', size: 80, totalRooms: 12, amenities: ['Panoramic View', 'Living Room', 'Dining Area'] },
    ],
  ...
  },
  {
    ...
    description: 'Nestled amid ancient rice terraces and lush tropical jungle in Ubud, Bali Jungle Eco Lodge provides an immersive cultural experience. Each villa features a private plunge pool and traditional Balinese architecture.',
    ...
    location: {
      ...
      nearbyAttractions: [
        { name: 'Tegalalang Rice Terraces', distance: '3 km', type: 'nature' },
        { name: 'Sacred Monkey Forest', distance: '1.5 km', type: 'attraction' },
      ],
    },
    coverImage: { url: HOTEL_IMAGES[3] },
    images: [{ url: HOTEL_IMAGES[3], isPrimary: true }, { url: HOTEL_IMAGES[7] }, { url: HOTEL_IMAGES[0] }],
    amenities: {
    ...
    rooms: [
      ...
      { roomType: 'Deluxe', pricePerNight: 185, maxGuests: 2, bedType: 'King', size: 65, totalRooms: 8, amenities: ['Rice Terrace View', 'Private Pool', 'Outdoor Bath'] },
      { roomType: 'Suite', pricePerNight: 280, maxGuests: 3, bedType: 'King', size: 95, totalRooms: 4, amenities: ['Jungle View', 'Private Pool', 'Separate Villa'] },
    ],
  ...
  },
  {
    ...
    description: 'Overlooking the crystalline Adriatic Sea and the UNESCO-listed Old City walls, Dubrovnik Pearl Hotel is your gateway to Croatia\'s most beloved coastal gem.',
    ...
    images: [{ url: HOTEL_IMAGES[4], isPrimary: true }, { url: HOTEL_IMAGES[2] }],
    amenities: {
      general: ['Free WiFi', 'Outdoor Pool', 'Sea View Terrace'],
  ...
  },
  {
    ...
    description: 'Hidden behind ancient medina walls, Marrakech Riad Luxe is a traditional Moroccan palace transformed into an intimate luxury retreat. Central courtyard fountains, handcrafted tiles, and authentic hammam experiences.',
    ...
    images: [{ url: HOTEL_IMAGES[5], isPrimary: true }, { url: HOTEL_IMAGES[7] }],
    amenities: {
    ...
    rooms: [
      { roomType: 'Standard', pricePerNight: 145, maxGuests: 2, bedType: 'Double', size: 30, totalRooms: 8, amenities: ['Courtyard View', 'Moroccan Decor'] },
      { roomType: 'Suite', pricePerNight: 290, maxGuests: 2, bedType: 'King', size: 65, totalRooms: 4, amenities: ['Rooftop Access', 'Private Terrace', 'Jacuzzi'] },
    ],
  ...
  },
  {
    ...
    description: 'Commanding the Manhattan skyline from its prime Midtown location, New York Midtown Grand offers iconic views of Central Park and the Empire State Building. Sophisticated rooms, Michelin-star dining, and legendary service.',
    ...
    images: [{ url: HOTEL_IMAGES[6], isPrimary: true }, { url: HOTEL_IMAGES[1] }],
    amenities: {
    ...
    rooms: [
      { roomType: 'Standard', pricePerNight: 350, maxGuests: 2, bedType: 'Queen', size: 30, totalRooms: 80, amenities: ['City View', 'Work Desk', 'Keurig'] },
      ...
      { roomType: 'Suite', pricePerNight: 950, maxGuests: 4, bedType: 'King', size: 110, totalRooms: 15, amenities: ['Skyline View', 'Living Room', 'Dining Area'] },
    ],
  ...
  },
  {
    ...
    description: 'Dramatically situated between Table Mountain and the Atlantic Ocean, Cape Town Ocean Escape offers one of the world\'s most breathtaking hotel settings. Contemporary African design meets world-class amenities.',
    ...
    images: [{ url: HOTEL_IMAGES[7], isPrimary: true }, { url: HOTEL_IMAGES[3] }],
    amenities: {
    ...
    rooms: [
      ...
      { roomType: 'Suite', pricePerNight: 420, maxGuests: 3, bedType: 'King', size: 80, totalRooms: 8, amenities: ['Ocean View', 'Plunge Pool', 'Living Room'] },
    ],
...
const packages = [
  {
    ...
    description: 'Immerse yourself in Bali\'s spiritual heart. From the emerald rice terraces of Ubud to the surf-kissed shores of Seminyak, this curated journey blends culture, nature, and luxury.',
    shortDescription: '7 days exploring Bali\'s culture, temples, and beaches',
    ...
    includes: { flights: true, accommodation: true, meals: 'Breakfast', transfers: true, guide: true },
    ...
    bookingCount: 1240,
    itinerary: [
      { day: 1, title: 'Arrival in Denpasar & Seminyak', activities: ['Airport pickup', 'Hotel check-in', 'Seminyak beach sunset', 'Welcome dinner'], meals: { breakfast: false, lunch: false, dinner: true } },
      { day: 2, title: 'Ubud Cultural Day', activities: ['Tegalalang Rice Terraces', 'Monkey Forest', 'Ubud Art Market', 'Traditional Dance Show'], meals: { breakfast: true, lunch: true, dinner: false } },
      { day: 3, title: 'Temple Trail', activities: ['Tanah Lot Temple', 'Uluwatu Cliff Temple', 'Kecak Fire Dance'], meals: { breakfast: true, lunch: false, dinner: true } },
    ],
  },
  {
    title: 'Maldives Honeymoon Dream: 5 Nights Overwater',
    description: 'The ultimate romantic escape. Your own overwater bungalow, private snorkeling reef, candlelit dinners on the beach, and dolphin cruises at dusk.',
    ...
    includes: { flights: true, accommodation: true, meals: 'All Inclusive', transfers: true },
  ...
  },
  {
    ...
    description: 'Chase the sakura across Japan\'s most iconic cities. From the neon canyons of Tokyo to the zen temples of Kyoto, experience Japan at its most breathtaking moment.',
  ...
  },
  {
    ...
    description: 'Sail the legendary Aegean between Santorini, Mykonos, and Athens. Whitewashed villages, ancient ruins, crystalline seas, and sun-soaked tavernas await.',
    ...
    includes: { flights: true, accommodation: true, meals: 'Breakfast', transfers: true },
    highlights: ['Santorini Sunset', 'Mykonos Party Beach', 'Acropolis & Parthenon', 'Island Ferry Hopping', 'Wine Tasting Tour'],
  ...
  },
  {
    ...
    description: 'From the labyrinthine medinas of Marrakech and Fes to a night under the Sahara stars, Morocco is a journey for all the senses.',
    ...
    includes: { flights: false, accommodation: true, meals: 'Half Board', transfers: true, guide: true },
  ...
  },
  {
    ...
    description: 'Witness the Big Five on Kruger safaris, marvel at mighty Victoria Falls, and cruise the Chobe River at golden hour in this unforgettable Southern Africa adventure.',
    ...
    includes: { flights: true, accommodation: true, meals: 'Full Board', transfers: true, guide: true },
...
const flights = [
  {
    flightNumber: 'TP101',
    airline: { name: 'TravelAir', code: 'TP', logo: 'https://flagcdn.com/us.svg' },
    ...
    basePrice: 480,
    stops: 0,
    seats: { economy: { total: 180, available: 45, price: 480 }, business: { total: 30, available: 8, price: 1850 } },
  ...
  {
    flightNumber: 'TP205',
    airline: { name: 'SkyWings', code: 'SW', logo: 'https://flagcdn.com/ae.svg' },
    ...
    basePrice: 620,
    stops: 0,
    seats: { economy: { total: 200, available: 78, price: 620 }, business: { total: 42, available: 15, price: 2400 } },
  ...
  {
    flightNumber: 'TP312',
    airline: { name: 'EuroJet', code: 'EJ', logo: 'https://flagcdn.com/de.svg' },
    ...
    basePrice: 220,
    stops: 0,
    seats: { economy: { total: 150, available: 62, price: 220 }, business: { total: 16, available: 5, price: 780 } },
  ...
  {
    flightNumber: 'TP450',
    airline: { name: 'AsiaWings', code: 'AW', logo: 'https://flagcdn.com/sg.svg' },
    origin: { city: 'Singapore', airport: 'Changi Airport', airportCode: 'SIN', country: 'Singapore', terminal: '3' },
    destination: { city: 'Bali', airport: 'Ngurah Rai International Airport', airportCode: 'DPS', country: 'Indonesia', terminal: 'I' },
    departureTime: new Date(Date.now() + 4 * 24 * 60 * 60 * 1000),
    arrivalTime: new Date(Date.now() + 4 * 24 * 60 * 60 * 1000 + 2 * 60 * 60 * 1000 + 20 * 60 * 1000),
    basePrice: 190,
    stops: 0,
    seats: { economy: { total: 160, available: 88, price: 190 }, business: { total: 20, available: 9, price: 650 } },
  ...
  },
  {
    flightNumber: 'TP567',
    airline: { name: 'TravelAir', code: 'TP', logo: 'https://flagcdn.com/us.svg' },
    origin: { city: 'Los Angeles', airport: 'Los Angeles International Airport', airportCode: 'LAX', country: 'USA', terminal: 'B' },
    ...
    basePrice: 780,
    stops: 0,
    seats: { economy: { total: 220, available: 35, price: 780 }, business: { total: 45, available: 12, price: 3200 }, firstClass: { total: 8, available: 3, price: 6500 } },
    baggage: { carryOn: '10 kg', checkedBaggage: '23 kg' },
    meals: 'Included',
    wifi: true,
    entertainment: true,
...
const seedDB = async () => {
  try {
    ...
    const users = await User.insertMany([
      { name: 'Alice Johnson', email: 'alice@example.com', password: 'Password@123', role: 'user', isEmailVerified: true, preferences: { budget: 'luxury', travelStyle: ['romantic', 'relaxation'] } },
      { name: 'Bob Smith', email: 'bob@example.com', password: 'Password@123', role: 'user', isEmailVerified: true, preferences: { budget: 'mid-range', travelStyle: ['adventure', 'cultural'] } },
      { name: 'Carol White', email: 'carol@example.com', password: 'Password@123', role: 'user', isEmailVerified: true, preferences: { budget: 'budget', travelStyle: ['solo', 'adventure'] } },
    ]);
    console.log(`👥 ${users.length} sample users created`);

    // Create hotels
    const createdHotels = await Hotel.insertMany(hotels.map(h => ({ ...h, owner: admin._id })));
    ...
    // Create packages
    const createdPackages = await TravelPackage.insertMany(packages.map(p => ({ ...p, createdBy: admin._id })));
    console.log(`📦 ${createdPackages.length} packages created`);

    // Create sample reviews
    const reviewData = createdHotels.slice(0, 4).flatMap((hotel, hi) =>
      users.slice(0, 2).map((user, ui) => ({
        user: user._id,
        hotel: hotel._id,
        title: ['Absolutely stunning!', 'Exceeded all expectations', 'Perfect getaway', 'Would return in a heartbeat'][hi * 2 + ui] || 'Amazing stay',
        review: 'The staff were incredibly attentive and the facilities were world-class. The location was perfect and the views were absolutely breathtaking. I will definitely be returning!',
        ratings: {
          overall: 4 + Math.random(),
          cleanliness: 4 + Math.random(),
          location: 4 + Math.random(),
          service: 4 + Math.random(),
          valueForMoney: 3.5 + Math.random(),
          facilities: 4 + Math.random(),
        },
        tripType: ['Leisure', 'Romantic', 'Family', 'Business'][ui % 4],
        isVerified: true,
      }))
    );
